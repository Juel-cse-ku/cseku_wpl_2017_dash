...
class Dash{
   ...
   // private $_Permission_ID;
    ...
    /*public function setPermisionID($PermisionID){
        $this->_Permision_ID = $PermisionID;
    }

    public function getPermisionID(){

        return $this->_Permision_ID;
    }

    public function setPermissionCategory($PermissionCategory){
        $this->_Permission_Category = $PermissionCategory;
    }

    public function getPermissionCategory(){

        return $this->_Permission_Category;
    }*/
}
class Result{
